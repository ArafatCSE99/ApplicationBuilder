    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Features Category -->
<?php
$sql = "SELECT * FROM features_category where module_id=$module_id";
$result = $conn->query($sql);
...
?>
          <li class="nav-item has-treeview">
            ...
            <!-- Features -->
<?php
$sqlf = "SELECT * FROM features where category_id=$category_id";
...
?>
            <li class="nav-item">
                <a href="#" onclick="getcontent('<?php echo $file; ?>')" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
