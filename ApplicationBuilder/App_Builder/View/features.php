...
$sql = "SELECT * FROM features where userid=$userid order by product_id,module_id,category_id,sequence";
    ...
    $category_name=$rowc["name"];
     ...
     echo "<td class='text-center py-0 align-middle' style='text-align:center;'>
                      <div class='btn-group btn-group-sm'>
                        ...
                        <a onclick=deletedata($id,this,'features') class='btn btn-danger'><i class='fas fa-trash'></i></a>
                      </div>
                    </td>";
     echo "</tr>";
...
<input type="hidden" name="featuresid" id="featuresid"  value="0">   
...
<div class="form-group">
  ...
  <?php
echo "<select style='width:80%' class='form-control' id='category'  required>";
